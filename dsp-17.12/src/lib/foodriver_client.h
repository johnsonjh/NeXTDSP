...
kern_return_t foodriver_get_device_parms (
...
kern_return_t foodriver_set_device_parms (
	port_t		device_port,		// valid device port
...
/* new in 2.0 */
kern_return_t foodriver_set_ramp (
	port_t		device_port,		// valid device port
	int		rampflags);		// Flags for setting ramp

kern_return_t foodriver_get_volume (
	port_t		device_port,		// valid device port
	int		*left_chan,		// returned volume
	int		*right_chan);

kern_return_t foodriver_set_volume (
	port_t		device_port,		// valid device port
	int		left_chan,		// volume on left channel
	int		right_chan);

kern_return_t foodriver_set_dsp_owner_port (
	port_t		device_port,		// valid device port
	port_t		owner_port,		// dsp owner port
	port_t		*neg_port);

kern_return_t foodriver_set_sndin_owner_port (
	port_t		device_port,		// valid device port
	port_t		owner_port,		// sound in owner port
	port_t		*neg_port);

kern_return_t foodriver_set_sndout_owner_port (
	port_t		device_port,		// valid device port
	port_t		owner_port,		// sound out owner port
	port_t		*neg_port);

kern_return_t foodriver_get_dsp_cmd_port (
	port_t		device_port,		// valid device port
	port_t		owner_port,		// valid owner port
	port_t		*cmd_port);

kern_return_t foodriver_dspcmd_req_msg (
	port_t		cmd_port,		// valid dsp command port
	port_t		reply_port);

kern_return_t foodriver_dspcmd_req_err (
	port_t		cmd_port,		// valid dsp command port
	port_t		reply_port);

kern_return_t foodriver_dspcmd_req_condition (	//?
	port_t		cmd_port,		// valid dsp command port
...
/* New for 2.0 */
kern_return_t foodriver_dsp_read_messages (
	port_t		cmd_port,		// valid command port
	void		*data,			// buffer pointer or NULL
	int		*count,			// count of data elements
	int		data_size,		// bytes per data element
...
kern_return_t foodriver_dsp_read (
	port_t		cmd_port,		// valid command port
...
kern_return_t foodriver_dsp_write (
	port_t		cmd_port,		// valid command port
	void		*data,			// pointer to buffer
	int		count,			// count of data elements
	int		data_size,		// bytes per data element
...
kern_return_t foodriver_dsp_boot (
	port_t		cmd_port,		// valid command port
 ...
 * New for 2.0.
 */
kern_return_t foodriver_stream_ndma (
 ...
 */
kern_return_t foodriver_dsp_reset (
	port_t		cmd_port,		// valid command port
	int		priority);		// priority of this transaction
 ...
 */
kern_return_t foodriver_new_device_port (
 ...
 */
kern_return_t foodriver_reset_dsp_owner (
	port_t		device_port,	// valid device port
 ...
 */
kern_return_t foodriver_reset_sndin_owner (
	port_t		device_port,	// valid device port
 ...
 */
kern_return_t foodriver_reset_sndout_owner (
	port_t		device_port,	// valid device port
 ...
 */
kern_return_t foodriver_dsp_dma_write (
	port_t		cmd_port,	// valid dsp command port
 ...
 */
kern_return_t foodriver_dsp_dma_read (
	port_t		cmd_port,	// valid dsp command port
...
/*
 * Set the size of the sound out buffers used by foodriver_stream_setup() when
 * it configures the stream.  The default is vm_page_size.
 * New in 2.0.
 */
kern_return_t foodriver_set_sndout_bufsize (
	port_t		dev_port,		// valid device port
	port_t		owner_port,		// valid owner port
	int		sobsize);		// so buf size

/*
 * Set the number of sound out buffers used by foodriver_stream_setup() when
 * it configures the stream.  The default is 4.
 * New in 2.0.
 */
kern_return_t foodriver_set_sndout_bufcount (
	port_t		dev_port,		// valid device port
	port_t		owner_port,		// valid owner port
	int		sobcount);		// so buf count

kern_return_t foodriver_stream_setup (
	port_t		dev_port,		// valid device port
	port_t		owner_port,		// valid owner port
...
kern_return_t foodriver_dsp_protocol (
	port_t		device_port,		// valid device port
 ...
 */
kern_return_t foodriver_stream_start_reading (
	port_t		stream_port,		// valid stream port
...
kern_return_t foodriver_stream_start_writing (
	port_t		stream_port,		// valid stream port
...
kern_return_t foodriver_stream_control (
	port_t		stream_port,		// valid stream port
	int		tag,			// tag to identify stream
	int		snd_control);

kern_return_t foodriver_stream_nsamples (
	port_t		stream_port,		// valid stream port
	int		*nsamples);
