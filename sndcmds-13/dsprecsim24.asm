; ================================================================
; This dsp 56000 assembler code will bring in 24 bit data from the SSI
...
tx2_wait	jclr	#Mo_TDE,x:Mo_SR,tx2_wait   ;  wait for tx ready
	movep	x:(r5)+,x:Mo_TX		; output rx data; increment pointer
...
;	movep	x:Mo_RX,x:(r5)+		; save data; increment r5 below!!!
	movep	x:Mo_RX,x:(r5)		; save data; increment r5 below!!!

tx_wait	jclr	#Mo_TDE,x:Mo_SR,tx_wait   ;  wait for tx ready
	movep	x:(r5)+,x:Mo_TX		; output rx data; increment pointer
...
tx3_wait	jclr	#Mo_TDE,x:Mo_SR,tx3_wait   ;  wait for tx ready
	movep	x:(r5)+,x:Mo_TX		; output rx data; increment pointer
