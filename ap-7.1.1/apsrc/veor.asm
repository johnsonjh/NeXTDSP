...
;;  --------------------
;;      07/13/89/mtm - created from vor
;;      
;;  ------------------------------ DOCUMENTATION ---------------------------
;;  NAME
;;      veor (AP macro) - vector exclusive or
;;          - exclusive or two vectors, creating a third
;;      
;;  SYNOPSIS
;;      include 'ap_macros' ; load standard DSP macro package
;;      veor     pf,ic,sinp_a,ainp_a0,iinp_a0,sinp_b,ainp_b0,iinp_b0,sout,aout0,iout0,cnt0
;;      
;;  MACRO ARGUMENTS
;;      pf      =   global label prefix (any text unique to invoking macro)
;;      ic      =   instance count (such that pf\_veor_\ic is globally unique)
...
;;      
;;  DESCRIPTION
;;      The veor array-processor macro computes C=(A EXCLUSIVE LOGICAL 
;;	OR B).
;;
;;  PSEUDO-C NOTATION
;;      ainp_a  =   x:(R_X)+;
...
;;      veor     ap,1,x,ax_vec,1,x,bx_vec,1,x,out1_vec,1,6
;;      end_ap  'tveor'
;;      end
;;      
;;  SOURCE
;;      /usr/lib/dsp/apsrc/veor.asm
;;      
;;  REGISTER USE 
...
;;      
veor     macro pf,ic,sinp_a,ainp_a0,iinp_a0,sinp_b,ainp_b0,iinp_b0,sout,aout0,iout0,cnt0

        ; argument definitions
        new_xarg    pf\_veor_\ic\_,ainp_a,ainp_a0
        new_xarg    pf\_veor_\ic\_,iinp_a,iinp_a0
        new_xarg    pf\_veor_\ic\_,ainp_b,ainp_b0
        new_xarg    pf\_veor_\ic\_,iinp_b,iinp_b0
        new_xarg    pf\_veor_\ic\_,aout,aout0
        new_xarg    pf\_veor_\ic\_,iout,iout0
        new_xarg    pf\_veor_\ic\_,cnt,cnt0
        ...
        tst     B
        jeq     pf\_veor_\ic\_loop1      ; protect againt count=0

        ; inner loop 
        do      B,pf\_veor_\ic\_loop1
            if "sinp_a"=="sinp_b" 
