...
;;  ------------------------------ DOCUMENTATION ---------------------------
;;  NAME
;;      vtvpvtv (AP macro) - vector multiply plus vector multiply
;;          - pointwise multiplication of two vectors, add pointwise multiply of two vectors
;;      
;;  SYNOPSIS
;;      include 'ap_macros' ; load standard DSP macro package
;;      vtvpvtv pf,ic,sinp_a,ainp_a0,iinp_a0,sinp_b,ainp_b0,iinp_b0,sinp_c,ainp_c0,iinp_c0,sinp_d,ainp_d0,iinp_d0,sout,aout0,iout0,cnt0
;;      
;;  MACRO ARGUMENTS
;;      pf      =   global label prefix (any text unique to invoking macro)
;;      ic      =   instance count (such that pf\_vtvpvtv_\ic is globally unique)
...
;;      
;;  DESCRIPTION
;;      The vtvpvtv array-processor macro computes E[k]=A[k]*B[k]+C[k]*D[k].
;;
;;  PSEUDO-C NOTATION
;;      ainp_a  =   x:(R_X)+;
;;      iinp_a  =   x:(R_X)+;
...
;;      
;;  DSPWRAP C SYNTAX
;;      ierr    =   DSPAPvtvpvtv(aS1,iS1,aS2,iS2,aS3,iS3,aS4,iS4,aD,iD,n);   /* D[k]=S1[k]*S2[k]+S3[k]*S4[k]
...
;;      vtvpvtv    ap,1,x,ax_vec,1,x,bx_vec,1,x,cx_vec,1,x,dx_vec,1,x,out1_vec,1,6
;;      end_ap  'tvtvpvtv'
;;      end
;;      
;;  SOURCE
;;      /usr/lib/dsp/apsrc/vtvpvtv.asm
;;      
;;  REGISTER USE  
;;      A       accumulator 
...
;;      
vtvpvtv    macro pf,ic,sinp_a,ainp_a0,iinp_a0,sinp_b,ainp_b0,iinp_b0,sinp_c,ainp_c0,iinp_c0,sinp_d,ainp_d0,iinp_d0,sout,aout0,iout0,cnt0

        ; argument definitions
        new_xarg    pf\_vtvpvtv_\ic\_,ainp_a,ainp_a0
        new_xarg    pf\_vtvpvtv_\ic\_,iinp_a,iinp_a0
        new_xarg    pf\_vtvpvtv_\ic\_,ainp_b,ainp_b0
        new_xarg    pf\_vtvpvtv_\ic\_,iinp_b,iinp_b0
        new_xarg    pf\_vtvpvtv_\ic\_,ainp_c,ainp_c0
        new_xarg    pf\_vtvpvtv_\ic\_,iinp_c,iinp_c0
        new_xarg    pf\_vtvpvtv_\ic\_,ainp_d,ainp_d0
        new_xarg    pf\_vtvpvtv_\ic\_,iinp_d,iinp_d0
        new_xarg    pf\_vtvpvtv_\ic\_,aout,aout0
        new_xarg    pf\_vtvpvtv_\ic\_,iout,iout0
        new_xarg    pf\_vtvpvtv_\ic\_,cnt,cnt0
