...
;;  ------------------------------ DOCUMENTATION ---------------------------
;;  NAME
;;      vand (AP macro) - vector and - and two vectors, creating a third
;;      
;;  SYNOPSIS
;;      include 'ap_macros' ; load standard DSP macro package
;;      vand    pf,ic,sinp_a,ainp_a0,iinp_a0,sinp_b,ainp_b0,iinp_b0,sout,aout0,iout0,cnt0
;;      
;;  MACRO ARGUMENTS
;;      pf      =   global label prefix (any text unique to invoking macro)
;;      ic      =   instance count (such that pf\_vand_\ic is globally unique)
...
;;      
;;  DESCRIPTION
;;      The vand array-processor macro computes C=A AND B.
;;
;;  PSEUDO-C NOTATION
;;      ainp_a  =   x:(R_X)+;
;;      iinp_a  =   x:(R_X)+;
...
;;      vand    ap,1,x,ax_vec,1,x,bx_vec,1,x,out1_vec,1,6
;;      end_ap  'tvand'
;;      end
;;      
;;  SOURCE
;;      /usr/lib/dsp/apsrc/vand.asm
;;      
;;  REGISTER USE 
;;      A       accumulator; holds current B vector term
;;      B       temp for testing for cnt==0
;;      X0,Y0   current A vector term
...
;;      
vand    macro pf,ic,sinp_a,ainp_a0,iinp_a0,sinp_b,ainp_b0,iinp_b0,sout,aout0,iout0,cnt0

        ; argument definitions
        new_xarg    pf\_vand_\ic\_,ainp_a,ainp_a0
        new_xarg    pf\_vand_\ic\_,iinp_a,iinp_a0
        new_xarg    pf\_vand_\ic\_,ainp_b,ainp_b0
        new_xarg    pf\_vand_\ic\_,iinp_b,iinp_b0
        new_xarg    pf\_vand_\ic\_,aout,aout0
        new_xarg    pf\_vand_\ic\_,iout,iout0
        new_xarg    pf\_vand_\ic\_,cnt,cnt0
        ...
        tst     B
        jeq     pf\_vand_\ic\_loop1     ; protect againt count=0

        ; inner loop 
        do      B,pf\_vand_\ic\_loop1
            if "sinp_a"=="sinp_b" 
