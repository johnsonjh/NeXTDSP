...
@implementation DswitchtUGyy : DswitchtUG

/* times in seconds/sample */
#define COMPUTETIME (106 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { i1adr, scale1, scale2, aout, i2adr, tickdelay };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_N,DSP_MS_N,DSP_MS_Y,DSP_MS_Y,DSP_MS_N};
   ...
   static int _dataP[] = {0xcb9800,0x47f400,0x1,0x44d87c,0x29040,
                          ...
                          0xf89800,0x29050,0x21d100,0x5efe00,0x61180,
                          0x91,0x4ed900,0x5e5ee1};
   static DSPFixup _fixupsP[] = {
   {DSP_LC_P, NULL, 1 /* decrement */, 15 /* refOffset */,  17 /* relAddress */}
   };
