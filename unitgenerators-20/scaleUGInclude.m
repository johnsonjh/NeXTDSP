/* This source file was auto-generated by dspwrap from dsp macro scale.
   It is included by unit generator ScaleUG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_scale_1_ainp","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_scale_1_aout","GRI"},
      {DSP_LC_Y,"orch_scale_1_ginp","GRI"}
   };
   ...
   _argSymbols[(int)ginp] = _symbolsY[1];
