...
@implementation Mul2UGxyy : Mul2UG
...
enum args { i1adr, aout, i2adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_X,DSP_MS_Y};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 10}; 
   static int _dataP[] = {0x6ddc00,0x6edc00,0x61d800,0x56fe00,0x61080,
                          0x88,0x4cd900,0x4edd00,0x565ed0,0x565e00};
   static DSPFixup _fixupsP[] = {
   {DSP_LC_P, NULL, 1 /* decrement */, 5 /* refOffset */,  8 /* relAddress */}
   };
