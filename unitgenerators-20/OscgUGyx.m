...
@implementation OscgUGyx : OscgUG
...
enum args { atab, mtab, amp, aout, inc, phs };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_N,DSP_MS_Y,DSP_MS_N,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 14}; 
   static int _dataP[] = {0x65d800,0x44e000,0x43da1b,0x41e200,0x6edc4e,
                          0x21bd00,0x4ddc00,0x61080,0x8b,0x44ed4e,
