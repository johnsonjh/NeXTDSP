/* This source file was auto-generated by dspwrap from dsp macro unoise.
   It is included by unit generator UnoiseUG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_unoise_1_aout","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_unoise_1_seed","GRI"}
   };
