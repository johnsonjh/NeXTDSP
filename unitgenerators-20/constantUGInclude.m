/* This source file was auto-generated by dspwrap from dsp macro constant.
   It is included by unit generator ConstantUG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_constant_1_aout","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_constant_1_cnst","GRI"}
   };
   ...
   _argSymbols[(int)cnst] = _symbolsY[0];
