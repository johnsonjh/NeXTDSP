...
@implementation Scl1add2UGyxy : Scl1add2UG
...
enum args { i1adr, i1gin, aout, i2adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_Y,DSP_MS_Y};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 9}; 
   static int _dataP[] = {0x61d800,0x47d800,0x6ddc00,0x6edc00,0xf2b900,
                          0x61080,0x88,0xf0b9c3,0x5e5e51};
