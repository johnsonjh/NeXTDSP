/* This source file was auto-generated by dspwrap from dsp macro interp.
   It is included by unit generator InterpUG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_interp_1_i1adr","GRI"},
      {DSP_LC_X,"orch_interp_1_i3adr","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_interp_1_aout","GRI"},
      {DSP_LC_Y,"orch_interp_1_i2adr","GRI"}
   };
   ...
   _argSymbols[(int)i3adr] = _symbolsX[1];
