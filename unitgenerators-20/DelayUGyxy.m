...
@implementation DelayUGyxy : DelayUG

/* times in seconds/sample */
#define COMPUTETIME (308 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { ainp, aout, pdel, adel, edel };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_Y,DSP_MS_Y,DSP_MS_Y,DSP_MS_Y};
   ...
   static int _dataP[] = {0x66d800,0x61d800,0x65e000,0x4edc00,0x4fdc00,
                          ...
                          0x21d500,0x0,0xcbb900,0x5e5d00,0x5f5e00,
                          0x22ae00,0x565800};
