...
@implementation DelayUGxxy : DelayUG

/* times in seconds/sample */
#define COMPUTETIME (312 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (388 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { ainp, aout, pdel, adel, edel };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_X,DSP_MS_Y,DSP_MS_Y,DSP_MS_Y};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 18}; 
   static int _dataP[] = {0x66d800,0x61d800,0x65e000,0x4edc00,0x4fdc00,
                          0x225d00,0x22ae00,0x61080,0x8f,0x200055,
                          0x21070,0x21d500,0x21d200,0xfbb900,0xbe5e00,
                          0x22ae00,0x565800,0x23b200};
   static DSPFixup _fixupsP[] = {
   {DSP_LC_P, NULL, 1 /* decrement */, 8 /* refOffset */,  15 /* relAddress */}
   };
