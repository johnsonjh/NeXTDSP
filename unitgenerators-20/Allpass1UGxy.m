...
@implementation Allpass1UGxy : Allpass1UG
...
enum args { ainp, bb0, aout, s };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_N,DSP_MS_X,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 12}; 
   static int _dataP[] = {0x61d800,0x6edc00,0x5ed900,0x57fe00,0xc19800,
                          0x61080,0x89,0x575ec6,0x21c779,0x5ed9cb,
                          0x575e00,0x4f5c00};
