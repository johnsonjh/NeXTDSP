...
@implementation DswitchUGxy : DswitchUG
...
enum args { i1adr, scale1, aout, i2adr, switchdelay };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_N,DSP_MS_X,DSP_MS_Y,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 17}; 
   static int _dataP[] = {0x61d800,0x6ddc00,0x6edc00,0xc79800,0x47f400,
                          0x1,0x56fe00,0x4ed900,0x61080,0x8c,
                          0xf83ee1,0x4edd7c,0x29050,0x565e00,0x24000b,
                          0x2f048,0x5f5c00};
