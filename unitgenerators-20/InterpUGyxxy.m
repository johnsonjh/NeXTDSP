...
@implementation InterpUGyxxy : InterpUG
...
enum args { i1adr, i3adr, aout, i2adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_Y,DSP_MS_Y,DSP_MS_X};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 17}; 
   static int _dataP[] = {0x61d800,0x6ddc00,0x44d800,0x6edc00,0x45d900,
                          0x57dd00,0x228700,0x20946c,0x0,0x61080,
                          0x8e,0x18dc61,0x45d9d3,0x57dd00,0x5e5e6c,
                          0x20f400,0x0};
