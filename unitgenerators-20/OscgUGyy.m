...
@implementation OscgUGyy : OscgUG

/* times in seconds/sample */
#define COMPUTETIME (152 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (232 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { atab, mtab, amp, aout, inc, phs };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_N,DSP_MS_N,DSP_MS_Y,DSP_MS_N,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 14}; 
   static int _dataP[] = {0x65d800,0x44e000,0x43da1b,0x41e200,0x6edc4e,
                          0x21bd00,0x4ddc00,0x61080,0x8b,0x4ced4e,
                          0x21bda1,0xb2c038,0x415a00,0x57d800};
