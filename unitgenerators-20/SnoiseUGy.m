/* This class was auto-generated by dspwrap from macro snoise. 
   It should not be edited. */

#import "SnoiseUGy.h"

@implementation SnoiseUGy : SnoiseUG

/* times in seconds/sample */
#define COMPUTETIME (56 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (100 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { aout, seed };
   ...
   static int _dataP[] = {0x66d81b,0x51f400,0x2,0x4ce401,0x45f400,
                          0x5599d1,0x2000a2,0x200022,0x61080,0x8a,
                          0x585e00,0x585c00};
   static DSPFixup _fixupsP[] = {
   {DSP_LC_P, NULL, 1 /* decrement */, 9 /* refOffset */,  10 /* relAddress */}
   };
