...
@implementation ScaleUGxx : ScaleUG
...
enum args { ainp, aout, ginp };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_X,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 10}; 
   static int _dataP[] = {0x61d800,0x6edc00,0x4fdc00,0x45d900,0x2000f1,
                          0x60f80,0x88,0x45d900,0x565ef1,0x565e00};
