/* This class was auto-generated by dspwrap from macro allpass1. 
   It should not be edited. */

#import "Allpass1UGxx.h"

@implementation Allpass1UGxx : Allpass1UG

/* times in seconds/sample */
#define COMPUTETIME (118 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (196 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { ainp, bb0, aout, s };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_X,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 12}; 
   static int _dataP[] = {0x61d800,0x6edc00,0x56d900,0x57fe00,0xc19800,
                          0x61080,0x89,0x575ec6,0x21c779,0x56d9cb,
                          0x575e00,0x4f5c00};
