/* This source file was auto-generated by dspwrap from dsp macro snoise.
   It is included by unit generator SnoiseUG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_snoise_1_aout","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_snoise_1_seed","GRI"}
   };
   ...
   _argSymbols[(int)seed] = _symbolsY[0];
