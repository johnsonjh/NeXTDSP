...
@implementation OscgafUGxyxx : OscgafUG

/* times in seconds/sample */
#define COMPUTETIME (194 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (312 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { aina, atab, inc, ainf, aout, mtab, phs };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_X,DSP_MS_N,DSP_MS_X,DSP_MS_X,DSP_MS_N,DSP_MS_N};
   ...
   static int _dataP[] = {0x6edc00,0x6ddc00,0xf49800,0x44d800,0x61d81b,
                          ...
                          0x61080,0x8f,0xf5bd00,0x565eaa,0x45e85e,
                          0x21b8f1,0x565e00,0x60e200,0x415a00};
