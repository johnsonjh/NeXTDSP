...
@implementation InterpUGxxyx : InterpUG
...
enum args { i1adr, i3adr, aout, i2adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_X,DSP_MS_X,DSP_MS_Y};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 15}; 
   static int _dataP[] = {0x61d800,0x6ddc00,0x44d800,0x6edc00,0xf7b900,
                          0x220700,0x20906c,0x0,0x61080,0x8c,
                          0x129861,0xf7b9d3,0x565e6c,0x20f000,0x0};
