...
@implementation Out2sumUGy : Out2sumUG

/* times in seconds/sample */
#define COMPUTETIME (196 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (364 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { sclA, iadr, sclB };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_N,DSP_MS_Y,DSP_MS_N};
   ...
   static int _dataP[] = {0xf59800,0x7f095,0x3fea,0x69dc00,0x66e500,
                          ...
                          0x61080,0x90,0x4cd900,0x5ee600,0x5fcda3,
                          0x5e5ecb,0x5f5e00,0x5f426,0xffffff};
