...
@implementation Mul1add2UGyyxx : Mul1add2UG
...
enum args { i1adr, i2adr, aout, i3adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_Y,DSP_MS_X,DSP_MS_Y,DSP_MS_X};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 16}; 
   static int _dataP[] = {0x61d800,0x65d800,0x220500,0x68dc00,0x6edc00,
                          0x5ed900,0x46dd00,0x44d800,0x61080,0x8d,
                          0x46ddd3,0x44d800,0x5e5e00,0x5ed900,0x20b000,
                          0x0};
