...
@implementation OscgafiUGxxxx : OscgafiUG

/* times in seconds/sample */
#define COMPUTETIME (456 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (672 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { aina, atab, inc, ainf, aout, mtab, phs };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_X,DSP_MS_N,DSP_MS_X,DSP_MS_X,DSP_MS_N,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 31}; 
   static int _dataP[] = {0x6edc00,0x69dc00,0x65d800,0xf09800,0x47d81b,
                          0x41e200,0x606200,0x6c6200,0x20f000,0x22b400,
                          0x56f45e,0x1,0x212510,0x61080,0x9b,
                          0x21bd56,0x219c61,0x47ed23,0x218500,0x56ec00,
                          0x200074,0x21c771,0x45d9f3,0x1598aa,0x2125f1,
                          0x19b45e,0x1,0x475e10,0x60e200,0x6ce200,
                          0x415a00};
   static DSPFixup _fixupsP[] = {
   {DSP_LC_P, NULL, 1 /* decrement */, 14 /* refOffset */,  27 /* relAddress */}
   };
