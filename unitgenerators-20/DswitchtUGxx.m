...
@implementation DswitchtUGxx : DswitchtUG
...
enum args { i1adr, scale1, scale2, aout, i2adr, tickdelay };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_N,DSP_MS_X,DSP_MS_X,DSP_MS_N};
   ...
   static int _dataP[] = {0xcb9800,0x47f400,0x1,0x44d87c,0x29040,
                          ...
                          0xf89800,0x29050,0x21d100,0x56fe00,0x61180,
                          0x91,0x44d900,0x565ea1};
