/* This source file was auto-generated by dspwrap from dsp macro add2.
   It is included by unit generator Add2UG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_add2_1_i1adr","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_add2_1_aout","GRI"},
      {DSP_LC_Y,"orch_add2_1_i2adr","GRI"}
   };
