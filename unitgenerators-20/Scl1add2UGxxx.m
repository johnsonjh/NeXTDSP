...
@implementation Scl1add2UGxxx : Scl1add2UG
...
enum args { i1adr, i1gin, aout, i2adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_X,DSP_MS_X};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 11}; 
   static int _dataP[] = {0x61d800,0x47d800,0x6ddc00,0x6edc00,0x46d900,
                          0x56dd00,0x61080,0x8a,0x46d9b3,0x44dd00,
                          0x565e41};
