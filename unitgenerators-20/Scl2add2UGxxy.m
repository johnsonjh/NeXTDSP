...
@implementation Scl2add2UGxxy : Scl2add2UG
...
enum args { i1adr, i1gin, aout, i2adr, i2gin };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_X,DSP_MS_Y,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 10}; 
   static int _dataP[] = {0x61d800,0x6ddc00,0xf59800,0x6edc00,0x44d900,
                          0x4edda0,0x61080,0x89,0xf0b9b3,0x565ea0};
