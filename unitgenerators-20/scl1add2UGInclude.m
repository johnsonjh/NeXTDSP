/* This source file was auto-generated by dspwrap from dsp macro scl1add2.
   It is included by unit generator Scl1add2UG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_scl1add2_1_i1adr","GRI"},
      {DSP_LC_X,"orch_scl1add2_1_i1gin","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_scl1add2_1_aout","GRI"},
      {DSP_LC_Y,"orch_scl1add2_1_i2adr","GRI"}
   };
