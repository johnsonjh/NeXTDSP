...
@implementation DswitchUGyx : DswitchUG

/* times in seconds/sample */
#define COMPUTETIME (160 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
#define OFFCHIP_COMPUTETIME (242 * (DSP_CLOCK_PERIOD / DSPMK_I_NTICK))
...
enum args { i1adr, scale1, aout, i2adr, switchdelay };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_N,DSP_MS_Y,DSP_MS_X,DSP_MS_N};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 17}; 
   static int _dataP[] = {0x61d800,0x6ddc00,0x6edc00,0xc79800,0x47f400,
                          0x1,0x5efe00,0x44d900,0x61080,0x8c,
                          0xb2d9a1,0x46dd7c,0x29050,0x5e5e00,0x24000b,
                          0x2f048,0x5f5c00};
