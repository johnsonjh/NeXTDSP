...
@implementation Mul2UGxxy : Mul2UG
...
enum args { i1adr, aout, i2adr };
   static DSPMemorySpace _argSpaces[] = {DSP_MS_X,DSP_MS_X,DSP_MS_Y};
   static DSPDataRecord _dataRecP = {NULL, DSP_LC_P, 0, 1, 9}; 
   static int _dataP[] = {0x6ddc00,0x6edc00,0x61d800,0x56fe00,0x61080,
                          0x87,0xf0b900,0x565ed0,0x565e00};
