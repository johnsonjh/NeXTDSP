/* This source file was auto-generated by dspwrap from dsp macro mul1add2.
   It is included by unit generator Mul1add2UG. It should not be edited.*/
...
#  define OFFSET(_x) _x.value.i
   ...
   static DSPSymbol _symbolsX[] = {
      {DSP_LC_X,"orch_mul1add2_1_i1adr","GRI"},
      {DSP_LC_X,"orch_mul1add2_1_i2adr","GRI"}
   };
   static DSPSymbol _symbolsY[] = {
      {DSP_LC_Y,"orch_mul1add2_1_aout","GRI"},
      {DSP_LC_Y,"orch_mul1add2_1_i3adr","GRI"}
   };
   ...
   _argSymbols[(int)i2adr] = _symbolsX[1];
   _argSymbols[(int)aout] = _symbolsY[0];
   _argSymbols[(int)i3adr] = _symbolsY[1];
