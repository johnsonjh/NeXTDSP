/* THIS FILE NEEDS TO BE KEPT IN SYNCH WITH THE LIBSYS VERSION!!! 
   Eventually, when stdio is thread-safe this file won't be needed. SIGH
   
   Note that this file is STILL not thread safe! But neither is the
   Music Kit.  It is, however, safe to use this code in one thread and
   stdio in the other.  */
   
/*
 *	_mkecvt converts to decimal
...
static char*
_mkecvt(arg, ndigits, decptp, signp, buff)
double arg;
...
static char*
_mkfcvt(arg, ndigits, decptp, signp, buff)
double arg;
int ndigits, *decptp, *signp;
char *buff;
{
...
double arg;
int ndigits, *decptp, *signp, eflag;
char *buf;
{
